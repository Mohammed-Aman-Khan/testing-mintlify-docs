---
description: Power the Glyph ESP32-C6 over USB-C or a Li-Po battery, including charging behavior, current draw, low-power sleep modes, and onboard power management.
