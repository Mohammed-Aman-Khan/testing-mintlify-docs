---
description: "Power the Glyph ESP32-C6 board via USB-C, an external 5V supply, or a LiPo battery with onboard charger, fuel gauge, and automatic source switching."
