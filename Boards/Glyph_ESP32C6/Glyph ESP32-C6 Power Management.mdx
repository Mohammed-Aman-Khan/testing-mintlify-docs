---
description: "Power the Glyph ESP32-C6 over USB-C or a single-cell lithium battery, monitor charge status, and configure deep sleep modes for low-power IoT projects."
