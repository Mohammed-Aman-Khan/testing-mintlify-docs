---
description: Power the Glyph ESP32-C6 from USB-C, a LiPo battery, or external supply, with details on onboard charging, voltage rails, and low-power sleep modes.
title: Glyph ESP32-C6 power management guide
---
