---
description: Overview of the Glyph ESP32-C6 board, with its RISC-V SoC, Wi-Fi 6, Bluetooth LE, Zigbee and Thread radios, GLINK Qwiic connector, and onboard peripherals.
title: Glyph ESP32-C6 board overview and features
---
