---
description: "Set up the Espressif ESP-IDF toolchain to build wireless Zigbee firmware that runs across the Glyph ESP32-C6 and Glyph ESP32-H2 development boards."
title: ESP-IDF
---
