---
description: Set up the ESP-IDF development framework to build Zigbee wireless communication between Glyph ESP32-C6 and Glyph ESP32-H2 boards, with example projects.
title: ESP-IDF
---
