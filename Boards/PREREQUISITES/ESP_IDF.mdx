---
description: Set up ESP-IDF and run a Zigbee example to establish wireless communication between the Glyph ESP32-C6 coordinator and the Glyph ESP32-H2 end device.
title: ESP-IDF
---
