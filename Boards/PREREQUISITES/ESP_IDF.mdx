---
description: Set up the ESP-IDF toolchain and build a Zigbee wireless communication example between Glyph ESP32-C6 and Glyph ESP32-H2 boards from the command line.
title: ESP-IDF setup and Zigbee example for GLYPH
---
