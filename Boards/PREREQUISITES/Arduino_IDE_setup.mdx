---
description: Install the Arduino IDE and add the Espressif ESP32 board package so you can compile and upload sketches to GLYPH ESP32-C3, C6, H2, and S3 boards.
title: Arduino IDE setup for GLYPH ESP32 boards
