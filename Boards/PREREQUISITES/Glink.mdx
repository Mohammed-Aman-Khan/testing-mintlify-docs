---
description: GLINK is the I2C expansion connector on every Glyph development board, electrically compatible with Qwiic and STEMMA QT for plug-and-play sensors.
title: GLINK connector for Qwiic and STEMMA QT
---
