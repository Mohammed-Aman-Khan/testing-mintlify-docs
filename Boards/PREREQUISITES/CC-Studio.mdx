---
description: Set up Texas Instruments Code Composer Studio (CCS) IDE to develop and debug firmware on TI MSPM0 microcontrollers used with G-Sense industrial sensors.
title: CCS-IDE Setup
---
