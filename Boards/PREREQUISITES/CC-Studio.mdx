---
description: Install and configure Texas Instruments Code Composer Studio (CCS) to develop, flash, and debug firmware on TI microcontrollers used with PCBCUPID boards.
title: Code Composer Studio (CCS) IDE setup
---
