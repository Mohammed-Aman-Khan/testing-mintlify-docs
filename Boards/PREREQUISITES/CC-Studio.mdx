---
description: Install and set up Code Composer Studio (CCS) on Windows, macOS, or Linux to develop and debug firmware for TI microcontrollers on Glyph add-on boards.
title: CCS-IDE Setup
---
