---
description: Power the Glyph ESP32-C3 over USB-C or a Li-Po battery, with details on charging, current limits, sleep modes, and the onboard power management circuitry.
