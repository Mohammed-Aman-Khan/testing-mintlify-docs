---
description: "Power the Glyph ESP32-C3 board via USB-C, an external 5V supply, or a single-cell LiPo battery, with onboard charging and automatic source switching."
