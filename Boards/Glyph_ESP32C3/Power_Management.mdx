---
description: "Power the Glyph ESP32-C3 over USB-C or a single-cell lithium battery, monitor charge status, and configure low-power deep sleep modes for IoT projects."
