---
description: Reference pinout for the Glyph ESP32-C3 board with GPIO numbering, alternate functions (I2C, SPI, UART, ADC), and labelled connector positions.
title: Glyph ESP32-C3 pinout reference
---
