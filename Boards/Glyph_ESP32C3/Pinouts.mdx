---
description: Pinout reference for the Glyph ESP32-C3, including GPIOs, power rails, I2C, SPI, UART, ADC, and the Glink connector, with a labeled diagram of the board.
