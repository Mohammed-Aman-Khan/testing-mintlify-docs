---
description: G-Sense CAP1203 3-channel capacitive touch controller with I²C interface and PWM output, ideal for touch buttons and slider controls on ESP32 boards.
