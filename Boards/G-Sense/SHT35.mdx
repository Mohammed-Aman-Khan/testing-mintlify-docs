---
description: Interface the G-Sense SHT35 high-accuracy temperature and humidity sensor over I²C with Arduino, ESP32, and GLYPH-C3 boards using example code.
