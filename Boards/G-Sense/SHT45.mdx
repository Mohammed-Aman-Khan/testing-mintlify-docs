---
description: Wire the G-Sense SHT45 next-generation precision humidity and temperature sensor to a GLYPH-C3 over I²C with pinout, schematic, and Arduino code.
title: SHT45 precision humidity and temperature sensor
---
