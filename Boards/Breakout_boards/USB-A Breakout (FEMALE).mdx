---
description: USB-A female breakout board that exposes the VBUS, GND, D+, and D- pins on through-hole pads, making it easy to prototype custom USB host devices.
title: USB-A [FEMALE]
---
