---
description: USB-A female breakout board exposing power and data pins on accessible headers for building custom USB hosts, hubs, and prototyping projects.
title: USB-A [FEMALE]
---
