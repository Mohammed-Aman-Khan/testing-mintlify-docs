---
description: "USB-A female breakout exposes the VBUS, GND, D+ and D- lines on a PCB so you can prototype custom USB hosts, hubs, and host-side hardware projects."
title: USB-A [FEMALE]
---
