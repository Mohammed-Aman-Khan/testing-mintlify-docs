---
description: USB-A male breakout board exposing power and data pins on a PCB to build custom USB devices like macro pads and dongles for host computers.
title: USB-A [MALE]
---
