---
description: "USB-A male breakout exposes VBUS, GND, D+ and D- on a plug-style PCB so you can build custom USB dongles, macro pads, and host-connected devices."
title: USB-A [MALE]
---
