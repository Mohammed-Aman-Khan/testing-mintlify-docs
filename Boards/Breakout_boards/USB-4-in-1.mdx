---
description: USB 4-in-1 hub breakout board exposing VBUS, D+, D-, and GND signals on accessible headers for USB signal conversion and development.
title: USB 4-in-1 hub breakout board
---
