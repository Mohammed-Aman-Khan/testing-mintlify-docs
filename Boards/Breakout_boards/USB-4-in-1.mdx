---
description: USB 4-in-1 breakout board exposing USB-A male, USB-A female, USB-B, and USB-C connectors on a single board for prototyping custom USB hardware.
