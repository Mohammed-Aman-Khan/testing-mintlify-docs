---
description: "USB-C breakout exposes the power and data lines of a USB Type-C connector on a small PCB for prototyping custom USB-C devices, cables, and adapters."
title: USB-C
---
