---
description: USB-C breakout board that exposes VBUS, GND, CC1, CC2, and data pins on solderable pads for prototyping custom USB-C cables, adapters, and devices.
title: USB-C
---
