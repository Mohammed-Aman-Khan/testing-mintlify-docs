---
description: Qwiic 4-in-1 breakout board with four JST-SH ports for connecting multiple Qwiic, STEMMA QT, and Glink I2C sensors to a single development board.
title: Qwiic 4-in-1
---
