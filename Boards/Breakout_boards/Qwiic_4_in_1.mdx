---
description: Qwiic 4-in-1 I²C splitter breakout that expands a single I²C port into four for easy plug-and-play sensor and module connections.
title: Qwiic 4-in-1 I²C splitter breakout board
---
