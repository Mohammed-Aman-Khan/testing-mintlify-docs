---
description: Qwiic 2-in-1 I²C splitter breakout board for connecting two Qwiic-compatible devices to a single I²C port using plug-and-play JST-SH connectors.
title: Qwiic 2-in-1 I²C splitter breakout board
---
