---
description: Set up Zigbee communication between a Glyph ESP32-C6 coordinator and a Glyph ESP32-H2 end device in the Arduino IDE, with full wiring and example code.
