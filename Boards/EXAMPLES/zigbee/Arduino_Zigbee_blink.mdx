---
description: "Set up Zigbee wireless communication between the Glyph ESP32-C6 and Glyph ESP32-H2 boards in the Arduino IDE, including full coordinator and end-device code."
