---
description: Set up Zigbee communication between GLYPH-C6 (ESP32-C6) and GLYPH-H2 (ESP32-H2) boards in the Arduino IDE, with coordinator and end-device example code.
