---
description: Interface an IR proximity sensor with the Glyph ESP32-C6 to detect nearby objects and obstacles, with wiring diagram, pinout, and Arduino example code.
