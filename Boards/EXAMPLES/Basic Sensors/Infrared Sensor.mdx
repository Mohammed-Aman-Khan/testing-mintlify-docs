---
description: "Wire an IR proximity sensor to the Glyph ESP32-C6 development board and read digital output in Arduino IDE for line following and obstacle detection."
