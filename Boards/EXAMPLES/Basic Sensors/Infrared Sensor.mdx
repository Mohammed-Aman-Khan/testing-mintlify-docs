---
description: Wire an infrared proximity sensor module to a GLYPH-C6 board and read its digital output to detect nearby objects, obstacles, or line edges.
title: Infrared proximity sensor with GLYPH-C6
---
