---
description: Interface an infrared (IR) sensor with the GLYPH-C6 ESP32 development board to detect objects and obstacles, with wiring and Arduino example code.
