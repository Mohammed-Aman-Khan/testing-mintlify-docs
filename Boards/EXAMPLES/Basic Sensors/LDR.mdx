---
description: Wire a light-dependent resistor to a GLYPH-C6 board with a voltage divider and read ambient light levels over the ADC for sensing brightness.
title: Light-dependent resistor (LDR) with GLYPH-C6
---
