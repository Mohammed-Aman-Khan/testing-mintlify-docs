---
description: Interface a Light Dependent Resistor (LDR) with the GLYPH-C6 ESP32 development board to measure ambient light, with wiring and Arduino example code.
