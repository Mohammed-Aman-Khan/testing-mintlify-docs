---
description: Read ambient light levels with a light-dependent resistor (LDR) wired to the Glyph ESP32-C6 analog input, including wiring, calibration, and example code.
