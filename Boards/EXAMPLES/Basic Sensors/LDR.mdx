---
description: "Interface a light-dependent resistor (LDR) with the Glyph ESP32-C6 board to read ambient brightness through an analog input pin in the Arduino IDE."
