---
description: Wire an HC-SR04 ultrasonic distance sensor to a GLYPH-C6 board and measure trigger and echo pulse timings to read distances in centimetres.
title: HC-SR04 ultrasonic distance sensor with GLYPH-C6
---
