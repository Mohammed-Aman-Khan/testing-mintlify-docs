---
description: "Measure distance with an HC-SR04 ultrasonic sensor on the Glyph ESP32-C6 development board using Arduino IDE example code and the trigger/echo pins."
