---
description: Measure distance with an HC-SR04 ultrasonic sensor connected to the Glyph ESP32-C6, including trigger and echo wiring, pinout, and Arduino example code.
