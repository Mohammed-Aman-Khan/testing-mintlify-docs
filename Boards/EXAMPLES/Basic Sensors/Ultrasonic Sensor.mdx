---
description: Measure distance with the HC-SR04 ultrasonic sensor and the GLYPH-C6 ESP32 development board, including wiring diagram and Arduino example code.
