---
description: "Detect open flames using an IR flame sensor wired to the Glyph ESP32 development board through an analog input pin and Arduino IDE example code."
