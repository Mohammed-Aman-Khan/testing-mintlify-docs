---
description: Detect open flames and high heat sources with an IR flame sensor wired to a Glyph ESP32 board via analog input, including wiring and example sketch.
