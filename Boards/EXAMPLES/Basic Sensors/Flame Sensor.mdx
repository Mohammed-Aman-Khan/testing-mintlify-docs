---
description: Detect the presence of fire using an analog flame sensor connected to the GLYPH ESP32 development board, with wiring details and Arduino example code.
