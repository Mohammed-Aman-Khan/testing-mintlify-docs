---
description: Wire a flame sensor module to a GLYPH ESP32 board, read the analog output, and trigger alerts when an open flame is detected nearby.
title: Flame sensor with GLYPH ESP32 board
---
