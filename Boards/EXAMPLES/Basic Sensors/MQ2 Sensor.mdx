---
description: Connect an MQ2 gas sensor to a GLYPH-C6 board to detect smoke, LPG, methane, and other combustible gases via analog and digital outputs.
title: MQ2 gas and smoke sensor with GLYPH-C6
---
