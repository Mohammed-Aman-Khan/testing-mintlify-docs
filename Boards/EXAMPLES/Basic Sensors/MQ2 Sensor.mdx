---
description: Detect smoke, LPG, methane, and combustible gases using the MQ2 gas sensor with the GLYPH-C6 ESP32 board, including wiring and Arduino example code.
