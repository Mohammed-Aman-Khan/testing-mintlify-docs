---
description: "Detect smoke, LPG, methane, and other flammable gases using the MQ2 gas sensor connected to the Glyph ESP32-C6 development board over an analog pin."
