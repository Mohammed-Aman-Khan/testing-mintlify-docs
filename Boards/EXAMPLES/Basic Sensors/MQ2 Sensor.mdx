---
description: Detect smoke, LPG, methane, and other combustible gases with the MQ2 sensor wired to a Glyph ESP32-C6 analog input, with wiring and example code.
