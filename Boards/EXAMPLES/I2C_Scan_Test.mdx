---
description: Run an I2C bus scanner on a GLYPH ESP32 board to discover the 7-bit addresses of connected sensors and modules and debug wiring issues.
title: I2C address scanner on GLYPH ESP32
---
# GLYPH I2C Scan
