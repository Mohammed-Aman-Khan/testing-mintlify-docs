---
description: Scan the I²C bus on a GLYPH ESP32 development board to discover connected sensors and modules, with example code that prints their addresses.
title: I²C scanner for GLYPH ESP32 boards
---
# GLYPH I2C Scan
