---
description: Run an I2C scanner sketch on the Glyph ESP32 board to discover the addresses of connected I2C sensors and modules before integrating them in a project.
title: I2C Scanner
---
# GLYPH I2C Scan
