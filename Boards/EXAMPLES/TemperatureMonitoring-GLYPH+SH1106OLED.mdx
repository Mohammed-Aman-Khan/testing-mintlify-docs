---
description: Fetch live temperature data from the OpenWeatherMap REST API over Wi-Fi on a GLYPH ESP32 and display it on an SH1106 I2C OLED screen.
title: OpenWeatherMap on SH1106 OLED with GLYPH
---
