---
description: "Fetch live weather from the OpenWeatherMap REST API on a Glyph ESP32 board and display the temperature on an SH1106 OLED screen over I2C in Arduino."
title: REST API + OLED
---
