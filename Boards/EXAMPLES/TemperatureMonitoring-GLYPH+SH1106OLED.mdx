---
description: Fetch live weather data from the OpenWeatherMap REST API on GLYPH-C3 and display the temperature on an SH1106 OLED screen with example code.
title: Weather monitoring on OLED with REST API
---
