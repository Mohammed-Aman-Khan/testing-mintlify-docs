---
description: Display live weather data from the OpenWeatherMap REST API on an SH1106 OLED screen attached to the Glyph ESP32 board, with wiring and example code.
title: REST API + OLED
---
