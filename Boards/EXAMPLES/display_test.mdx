---
description: Run an OLED display test on a GLYPH ESP32 board to render text, shapes, and graphics on an SSD1306 or SH1106 screen over the I2C bus.
title: OLED display test on GLYPH ESP32
---
