---
description: Train and deploy a gesture recognition machine learning model on the GLYPH ESP32 using Edge Impulse, an IMU sensor, and embedded TinyML inference.
title: Gesture recognition with Edge Impulse and ESP32
---
