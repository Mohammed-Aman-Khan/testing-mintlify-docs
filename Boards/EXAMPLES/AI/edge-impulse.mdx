---
description: Train and deploy a gesture recognition model on the ESP32 with Edge Impulse, covering data collection, model training, and on-device inference.
