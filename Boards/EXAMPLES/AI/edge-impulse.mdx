---
description: Train and deploy a gesture recognition machine learning model on ESP32 using Edge Impulse, with data collection, training, and on-device inference.
