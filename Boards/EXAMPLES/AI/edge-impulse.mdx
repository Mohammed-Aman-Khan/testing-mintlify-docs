---
description: "Train and deploy a gesture recognition model on the Glyph ESP32 using Edge Impulse, accelerometer data, and on-device machine learning inference."
