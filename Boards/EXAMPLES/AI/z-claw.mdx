---
description: Build Z-Claw, a tiny AI personal assistant on the GLYPH-C3 board for voice control, home automation, and reminders using cloud LLM services.
title: Z-Claw AI assistant on GLYPH-C3
---
