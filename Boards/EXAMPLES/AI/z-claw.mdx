---
description: Build the Z-Claw AI claw machine using the GLYPH ESP32, servo motors, and computer vision to detect and grab objects autonomously.
title: Build the Z-Claw AI claw machine
---
