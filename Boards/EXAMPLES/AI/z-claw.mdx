---
description: Build the Z-Claw, an AI-powered robotic claw project that combines ESP32 control with computer vision to identify and pick up objects autonomously.
