---
description: "Build the Z-Claw AI robotic claw project with the Glyph ESP32, servo motors, and computer-vision-driven object detection for pick-and-place tasks."
