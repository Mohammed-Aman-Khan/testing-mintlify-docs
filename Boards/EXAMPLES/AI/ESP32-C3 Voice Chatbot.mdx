---
description: Build an AI voice chatbot on the ESP32-C3 using Deepgram for speech-to-text, n8n for orchestration, and Groq for fast LLM responses.
title: Build a voice chatbot on ESP32-C3
---
