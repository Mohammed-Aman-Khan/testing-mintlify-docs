---
description: "Build a mini AI voice assistant on the Glyph ESP32-C3 using Deepgram for speech-to-text, n8n for orchestration, and Groq for fast LLM responses."
