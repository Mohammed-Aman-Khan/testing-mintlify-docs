---
description: Build a DIY AI voice chatbot on the ESP32-C3 using Deepgram for speech-to-text, n8n for workflow automation, and Groq for fast LLM responses.
