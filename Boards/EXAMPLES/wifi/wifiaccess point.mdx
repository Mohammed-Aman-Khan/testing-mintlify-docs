---
description: Configure the GLYPH-C3 ESP32 board as a Wi-Fi access point and control an LED from a connected client device, with setup steps and Arduino code.
title: Wi-Fi access point on GLYPH-C3
---
