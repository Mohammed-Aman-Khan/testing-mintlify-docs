---
description: Configure a GLYPH ESP32 board as a Wi-Fi access point so other devices can connect directly to it without an external router or internet uplink.
title: Wi-Fi access point mode on GLYPH ESP32
---
