---
description: Configure the Glyph ESP32 board as a Wi-Fi access point with its own SSID and password so other devices can connect directly without an external router.
