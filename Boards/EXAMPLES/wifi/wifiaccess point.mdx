---
description: "Configure the Glyph ESP32 development board as a Wi-Fi access point so other devices can connect directly without needing an external router or network."
