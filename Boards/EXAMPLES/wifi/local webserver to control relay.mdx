---
description: Host a local web server on a GLYPH ESP32 board over Wi-Fi to toggle bulbs and appliances through a dual-channel relay from any browser.

title: Web-controlled 2-channel relay over Wi-Fi
---
