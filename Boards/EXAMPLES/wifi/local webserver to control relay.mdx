---
description: "Host a local web server on the Glyph ESP32 over Wi-Fi to switch a dual-channel relay module on and off from any browser for remote bulb and load control."
