---
description: Control a dual-channel relay over Wi-Fi by hosting a local web server on the Glyph ESP32 board, with HTML controls to switch bulbs on and off remotely.
