---
description:  Host a local web server on a GLYPH ESP32 board over Wi-Fi to control a 2-channel relay and switch bulbs on or off from a browser, with example code.
