---
description: Read position, rotation direction, and button presses from a rotary encoder using a GLYPH ESP32 development board, with wiring and Arduino example code.
