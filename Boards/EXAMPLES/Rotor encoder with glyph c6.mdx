---
description: Read the position, rotation direction, and push-button presses of a rotary encoder with a GLYPH-C6 board using interrupts in Arduino IDE.
title: Rotary encoder with GLYPH-C6
---
