---
description: Decode position, direction, and button presses from a rotary encoder using interrupts on the Glyph ESP32-C6 development board, with wiring and code.
