---
description: "Read position, rotation direction, and push-button presses from a rotary encoder using the Glyph ESP32-C6 development board with Arduino IDE code."
