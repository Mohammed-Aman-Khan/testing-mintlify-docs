---
description: Wire and program a 16×2 character LCD display with a GLYPH ESP32 development board using parallel mode, including pinout and Arduino example code.
title: 16×2 LCD display with GLYPH ESP32
---
