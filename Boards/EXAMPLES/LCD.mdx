---
description: Drive a parallel HD44780 character LCD from a GLYPH ESP32 board using the LiquidCrystal Arduino library to print text on 16x2 or 20x4 displays.
title: HD44780 parallel character LCD with GLYPH
---
