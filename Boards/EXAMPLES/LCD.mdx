---
description: "Drive a character LCD display from the GLYPH ESP32 development board using parallel pins and the LiquidCrystal library, with wiring and code."
title: LCD Display
---
