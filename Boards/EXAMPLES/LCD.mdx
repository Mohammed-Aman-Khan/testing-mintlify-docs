---
description: Wire a 16x2 character LCD to a Glyph ESP32 board in parallel mode and print messages with the LiquidCrystal Arduino library, with pinout and example code.
title: LCD Display
---
