---
description: "Drive a parallel 16x2 character LCD from the Glyph ESP32 development board using the Arduino LiquidCrystal library to display text and runtime data."
title: LCD Display
---
