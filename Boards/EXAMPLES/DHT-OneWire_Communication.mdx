---
description: Read temperature and humidity from a DHT11 or DHT22 sensor using the one-wire protocol with GLYPH ESP32 boards, including wiring and Arduino example code.
