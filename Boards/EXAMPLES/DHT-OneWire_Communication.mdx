---
description: Read temperature and humidity from a DHT11 or DHT22 sensor over the One-Wire protocol on a GLYPH ESP32 board using the Arduino DHT library.
title: DHT temperature and humidity sensor over One-Wire
---
