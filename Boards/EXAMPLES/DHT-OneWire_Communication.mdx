---
description: "Read temperature and humidity from a DHT11 or DHT22 sensor on a Glyph ESP32 development board using the one-wire protocol and Arduino IDE example code."
