---
description: Read temperature and humidity from a DHT11 or DHT22 sensor using one-wire communication on a Glyph ESP32 development board, with wiring and code.
