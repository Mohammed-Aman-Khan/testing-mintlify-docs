---
description: Drive a 16x2 character LCD with a PCF8574 I2C backpack from a GLYPH ESP32 board using only two I2C wires for SDA and SCL plus power.
title: I2C character LCD with GLYPH ESP32
---
