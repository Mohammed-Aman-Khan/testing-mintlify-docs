---
description: "Connect a 16x2 LCD with PCF8574 I2C backpack to the Glyph ESP32 development board and print text over I2C using only two pins in the Arduino IDE."
title: LCD I2C
---
