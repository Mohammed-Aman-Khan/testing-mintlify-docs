---
description: Drive a 16×2 LCD over I²C with a GLYPH ESP32 development board using only two wires (SDA and SCL), with wiring details and Arduino example code.
title: I²C 16×2 LCD display with GLYPH ESP32
---
