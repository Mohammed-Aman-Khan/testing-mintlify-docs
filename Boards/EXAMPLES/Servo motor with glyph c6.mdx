---
description: Control a hobby servo motor with PWM on a GLYPH-C6 development board using the ESP32 Arduino Servo library and sweep through positions.
title: Servo motor control with GLYPH-C6 PWM
---
