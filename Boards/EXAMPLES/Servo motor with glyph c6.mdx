---
description: Control the angle of an SG90 hobby servo motor with PWM signals from the Glyph ESP32-C6, including wiring, power considerations, and example sketch.
title: Servo Motor
---
