---
description: "Measure LiPo battery voltage on the Glyph ESP32 development board using the onboard voltage divider and ADC to monitor charge state in your sketch."
