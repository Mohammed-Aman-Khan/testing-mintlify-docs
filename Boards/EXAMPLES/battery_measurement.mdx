---
description: Measure the onboard lithium battery voltage on the Glyph ESP32 board using the dedicated ADC pin and convert the reading to a percentage state of charge.
