---
description: Set up a Bluetooth Low Energy (BLE) server on a GLYPH ESP32 development board with example code to advertise, connect, and exchange data.
title: BLE server demo on GLYPH ESP32
