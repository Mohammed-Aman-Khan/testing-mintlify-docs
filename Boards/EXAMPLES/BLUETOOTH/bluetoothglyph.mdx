---
description: "Run a Bluetooth Low Energy server demo on the Glyph ESP32 board to advertise a custom BLE service and exchange data with a smartphone or BLE client."
