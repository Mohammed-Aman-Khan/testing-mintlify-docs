---
description: Set up a Bluetooth Low Energy GATT server on a GLYPH ESP32 board, advertise a service, and read characteristics from a phone or BLE client.
title: BLE GATT server demo on GLYPH ESP32
