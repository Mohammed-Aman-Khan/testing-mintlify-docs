---
description: "Use the Glyph ESP32 development board to call the OpenWeatherMap REST API over Wi-Fi and print live temperature and weather data to the serial monitor."
title: REST API
---
