---
description: Call the OpenWeatherMap REST API over Wi-Fi from a GLYPH ESP32 board to fetch real-time temperature, humidity, and weather conditions as JSON.
title: Call OpenWeatherMap REST API from GLYPH
---
