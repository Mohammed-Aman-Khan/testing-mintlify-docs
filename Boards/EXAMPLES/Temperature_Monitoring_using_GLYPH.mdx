---
description: Call the OpenWeatherMap REST API from a GLYPH ESP32 development board over Wi-Fi to fetch live temperature data, with setup and Arduino code.
title: REST API calls with GLYPH ESP32
---
