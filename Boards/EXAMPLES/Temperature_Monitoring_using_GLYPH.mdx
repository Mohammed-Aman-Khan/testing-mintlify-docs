---
description: Fetch current temperature data from the OpenWeatherMap REST API over Wi-Fi using the Glyph ESP32 board and print it to the serial monitor for logging.
title: REST API
---
