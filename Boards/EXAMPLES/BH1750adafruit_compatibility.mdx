---
description: Connect a GLYPH ESP32 development board with the BH1750 Adafruit light sensor using the GLINK and QWIIC connectors, with wiring and example code.
