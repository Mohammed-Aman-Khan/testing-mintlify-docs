---
description: "Connect a BH1750 Adafruit ambient light sensor to a Glyph development board over I2C using the Glink Qwiic connector and read lux values in Arduino."
