---
description: Connect an Adafruit BH1750 ambient light sensor to a GLYPH development board over I2C using the GLINK and Qwiic/STEMMA QT connectors.
title: BH1750 Adafruit sensor with GLYPH and Qwiic
---
