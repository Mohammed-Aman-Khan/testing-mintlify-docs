---
description: Connect an Adafruit BH1750 light sensor to a Glyph development board over I2C using the Glink and Qwiic connectors, with wiring and example code.
