---
description: "Power the Glyph ESP32-H2 board via USB-C, an external 5V supply, or a LiPo battery using the onboard charger and automatic power source switching."
