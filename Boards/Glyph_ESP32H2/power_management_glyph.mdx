---
description: Power the Glyph ESP32-H2 over USB-C or a Li-Po battery, including charging behavior, current draw, sleep modes, and onboard power management circuitry.
