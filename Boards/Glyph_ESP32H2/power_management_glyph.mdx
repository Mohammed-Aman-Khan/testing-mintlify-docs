---
description: Power the Glyph ESP32-H2 from USB-C, a LiPo battery, or external supply, with details on onboard charging, voltage rails, and low-power sleep modes.
title: Glyph ESP32-H2 power management guide
---
