---
description: "Tour the Glyph ESP32-H2 board: GPIO pin assignments, power rails, communication buses, USB-C port, and Glink connector reference pinout diagram."
