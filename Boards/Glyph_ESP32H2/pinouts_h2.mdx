---
description: Pinout reference for the Glyph ESP32-H2, including GPIOs, power rails, I2C, SPI, UART, ADC, and the Glink connector, with a labeled diagram of the board.
