---
description: "Reference pinout for the Glyph ESP32-H2 board covering GPIO, ADC, I2C, SPI, UART, JTAG, strapping pins, power rails, and onboard peripheral connections."
