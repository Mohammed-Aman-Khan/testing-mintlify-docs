---
description: Reference pinout for the Glyph ESP32-H2 board with GPIO numbering, alternate I2C, SPI, UART, ADC functions, and labelled Zigbee and Thread connectors.
title: Glyph ESP32-H2 pinout reference
---
