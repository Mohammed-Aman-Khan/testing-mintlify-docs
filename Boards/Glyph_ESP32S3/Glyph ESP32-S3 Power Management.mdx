---
description: Power the Glyph ESP32-S3 from USB-C, a LiPo battery, or external supply, with details on onboard charging, voltage rails, and low-power sleep modes.
title: Glyph ESP32-S3 power management guide
---
