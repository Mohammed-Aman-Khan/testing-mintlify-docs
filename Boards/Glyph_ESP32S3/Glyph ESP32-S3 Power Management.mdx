---
description: Power the Glyph ESP32-S3 over USB-C or a Li-Po battery, with details on charging, current limits, USB OTG behavior, sleep modes, and power management.
