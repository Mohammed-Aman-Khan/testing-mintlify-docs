---
description: "Wire the G-Mod microSD card module to the Glyph ESP32 development board over SPI and read or write files using the Arduino SD library and example code."
title: Micro SD Card
---
