---
description: Interface a G-Mod microSD card module with the Glyph ESP32 board over SPI to read and write files, with wiring, formatting tips, and example sketches.
title: Micro SD Card
---
