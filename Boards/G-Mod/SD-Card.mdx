---
description: Interface a G-Mod micro SD card module with a GLYPH ESP32 board over SPI to read, write, and log files to FAT-formatted storage from Arduino.
title: Micro SD card module with GLYPH ESP32
---
