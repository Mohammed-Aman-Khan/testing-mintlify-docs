---
description: Interface the G-MOD Micro SD card module with a GLYPH ESP32 development board over SPI to read and write files, with wiring and Arduino example code.
title: Micro SD Card
---
