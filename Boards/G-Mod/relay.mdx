---
description: Interface a dual-channel G-Mod relay module with a GLYPH ESP32 board over Arduino IDE to switch two high-voltage loads from digital GPIO pins.
title: 2-channel relay module with GLYPH ESP32
---
