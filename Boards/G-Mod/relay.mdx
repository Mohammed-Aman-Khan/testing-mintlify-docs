---
description: "Interface the G-Mod 2-channel relay module with the Glyph ESP32 development board in the Arduino IDE to independently switch two AC or DC loads on and off."
title: 2-CH-RELAY
---
