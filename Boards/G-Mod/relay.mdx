---
description: Interface the G-MOD 2-channel relay module with a GLYPH ESP32 development board using Arduino IDE to switch two AC or DC loads, with wiring and code.
title: 2-CH-RELAY
---
