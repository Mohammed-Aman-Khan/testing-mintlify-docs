---
description: Switch two independent high-voltage loads with a 2-channel relay module driven by the Glyph ESP32 board, including wiring, isolation, and example code.
title: 2-CH-RELAY
---
