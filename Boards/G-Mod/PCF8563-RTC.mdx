---
description: PCF8563 real-time clock module with I²C interface, low-power operation, and alarm output for precise timekeeping on Arduino and ESP32 projects.
title: PCF8563 real-time clock (RTC) module
---
