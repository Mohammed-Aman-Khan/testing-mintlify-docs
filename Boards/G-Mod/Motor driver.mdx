---
description: Control two DC motors with the G-Mod TB6612FNG dual H-bridge motor driver and the Glyph ESP32 board, including speed, direction, and PWM examples.
