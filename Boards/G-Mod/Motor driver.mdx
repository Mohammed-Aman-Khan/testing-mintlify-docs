---
description: "Drive two DC motors with the G-Mod TB6612FNG dual H-bridge motor driver wired to the Glyph ESP32, with PWM speed and direction control example code."
