---
description: G-Mod TB6612FNG dual motor driver module controls two DC motors with an integrated dual H-bridge IC, PWM speed control, and direction inputs.
