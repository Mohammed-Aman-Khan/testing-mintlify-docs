---
description: Use a mechanical limit switch with the Glyph ESP32 board to detect end-of-travel or trigger events in motorized projects, with wiring and example code.
title: Limit Switch
---
