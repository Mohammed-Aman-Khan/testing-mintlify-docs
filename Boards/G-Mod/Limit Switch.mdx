---
description: Connect a G-Mod limit switch module to a GLYPH ESP32 board to detect end-of-travel events for sliding doors, CNC axes, and motion projects.
title: Limit switch module with GLYPH ESP32
---
