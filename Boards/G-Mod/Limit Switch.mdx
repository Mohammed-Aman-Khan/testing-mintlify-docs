---
description: Interface the G-MOD limit switch module with a GLYPH ESP32 development board to detect position, end-stops, and contact in motion or robotics projects.
title: Limit Switch
---
