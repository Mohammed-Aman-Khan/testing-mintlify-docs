---
description: Interface a single-channel G-Mod relay module with a GLYPH ESP32 board over Arduino IDE to switch high-voltage loads from a digital GPIO pin.
title: 1-channel relay module with GLYPH ESP32
---
