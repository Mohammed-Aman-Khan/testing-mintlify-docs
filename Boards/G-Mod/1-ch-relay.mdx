---
description: Interface a single-channel G-MOD relay module with a GLYPH ESP32 development board using the Arduino IDE to switch AC or DC loads, with wiring and code.
title: 1-CH-RELAY
---
