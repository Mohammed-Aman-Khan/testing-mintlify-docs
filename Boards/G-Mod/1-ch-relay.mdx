---
description: Switch high-voltage AC or DC loads with a single-channel relay module driven by the Glyph ESP32 board, with wiring, isolation notes, and Arduino code.
title: 1-CH-RELAY
---
