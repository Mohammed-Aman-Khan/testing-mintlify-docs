---
description: MCP79412 real-time clock module with I²C interface, battery backup, alarms, and EEPROM memory for accurate timekeeping on Arduino and ESP32 boards.
title: MCP79412 real-time clock (RTC) module
---
