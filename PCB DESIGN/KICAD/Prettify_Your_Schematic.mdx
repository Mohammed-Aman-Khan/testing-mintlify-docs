---
description: Polish a KiCad schematic with text labels, frames, hierarchical sheets, and reference designator cleanup so the final drawing is clear and presentable.
