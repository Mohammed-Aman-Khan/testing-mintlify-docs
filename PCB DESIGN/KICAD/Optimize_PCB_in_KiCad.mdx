---
description: Optimize a KiCad PCB layout for cost, manufacturability, and signal integrity by refining component placement, trace routing, and copper pour strategy.
