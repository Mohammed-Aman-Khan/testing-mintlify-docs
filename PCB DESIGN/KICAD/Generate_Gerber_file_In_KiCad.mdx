---
description: Export your KiCad PCB project as Gerber and Excellon drill files with the correct layer settings, ready for submission to a PCB fabrication house.
title: Generate Gerber files for manufacturing in KiCad
