---
description: Route PCB traces effectively in KiCad with manual and interactive routing techniques, covering trace widths, vias, differential pairs, and best practices.
