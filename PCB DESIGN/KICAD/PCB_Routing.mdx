---
description: Route traces and vias in the KiCad PCB editor using interactive routing, length tuning, and differential pairs, with tips for clean signal routing.
title: PCB routing in KiCad with interactive tools
