---
description: "Step-by-step guide to routing traces in the KiCad PCB editor, including track widths, via placement, and best practices for clean signal paths."
