---
description: Route traces in the KiCad PCB editor with manual, push-and-shove, and interactive routing techniques, plus tips on layer use, vias, and trace widths.
