---
description: "Run the KiCad design rule check (DRC) to verify your PCB layout, fix violations, and add branding artwork like logos and silkscreen text to your board."
