---
description: Verify your KiCad PCB layout with the Design Rule Checker (DRC) and add branding elements such as logos and silkscreen text before manufacturing.
