---
description: Run the KiCad Design Rule Checker (DRC) to verify clearances and connectivity, then add silkscreen branding and graphics to your PCB layout.
title: Run DRC and add branding in KiCad
