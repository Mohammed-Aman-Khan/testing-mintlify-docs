---
description: Verify your KiCad PCB layout with the design rule checker (DRC) to catch clearance and connectivity issues, and add silkscreen branding before fabrication.
