---
description: Run a design rule check (DRC) and export Gerber, drill, and pick-and-place files from EasyEDA so your PCB design is ready to send to a manufacturer.
