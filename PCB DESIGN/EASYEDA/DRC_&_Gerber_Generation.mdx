---
description: "Run a design rule check (DRC) on your EasyEDA PCB and export Gerber, drill, and BOM files to send to manufacturers like JLCPCB or LionCircuits."
