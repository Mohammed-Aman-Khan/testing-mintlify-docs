---
description: Run a Design Rule Check (DRC) in EasyEDA and export your PCB layout as Gerber and drill files ready for submission to a manufacturing fab.
title: DRC and Gerber file export in EasyEDA
