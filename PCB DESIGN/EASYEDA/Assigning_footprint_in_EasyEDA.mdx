---
description: "Assign and create custom PCB footprints for your schematic components in EasyEDA, with a walkthrough of the footprint manager and library tools."
