---
description: Learn how to assign existing footprints to schematic symbols and create new custom PCB footprints in EasyEDA for components that are not in the library.
title: Assign and create footprints in EasyEDA
