---
description: "Assign existing footprints and create custom footprints for your schematic components in EasyEDA so they map correctly onto the final PCB layout."
