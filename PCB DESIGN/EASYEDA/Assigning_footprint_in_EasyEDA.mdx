---
description: Learn how to assign existing footprints and create custom footprints for schematic components in EasyEDA, so your PCB layout matches your design intent.
