---
description: Learn how to assign and create custom PCB footprints for schematic components in EasyEDA, with step-by-step examples for surface-mount and through-hole parts.
