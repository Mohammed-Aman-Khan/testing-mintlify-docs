---
description: "Power the Glyph ESP32-S3 over USB-C or a single-cell lithium battery, monitor charge status, and configure deep sleep modes for low-power IoT projects."
