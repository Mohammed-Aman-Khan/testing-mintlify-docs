---
description: Download STL files and 3D print custom enclosures for GLYPH ESP32 development boards to protect them in projects, prototypes, and finished products.
title: 3D printed enclosures for GLYPH ESP32 boards
---
