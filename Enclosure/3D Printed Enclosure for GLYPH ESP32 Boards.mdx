---
description: 3D printable enclosure files and assembly guide for Glyph ESP32 boards, including STL downloads, print settings, and mounting holes for headers and ports.
