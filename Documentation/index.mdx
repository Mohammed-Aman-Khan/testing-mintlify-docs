...
<Columns cols={2}>
  ...
  <Card title="PCB Design" icon="pencil-ruler" href="guides/pcb-design/kicad/introduction-on-kicad">
...
<Columns cols={3}>
  <Card title="KiCad Tutorials" icon="file-text" href="guides/pcb-design/kicad/introduction-on-kicad">
    Comprehensive guides on designing PCBs using KiCad.
  </Card>

  <Card title="EasyEDA Tutorials" icon="file-text" href="guides/pcb-design/easyeda/easyeda-intro">
