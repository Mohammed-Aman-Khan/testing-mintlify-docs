---
description: "Power the Glyph ESP32-H2 over USB-C or a single-cell lithium battery, monitor charge status, and configure deep sleep modes for low-power mesh nodes."
